    ...
    <div className='absolute left-0 top-0 z-50 m-0 h-screen w-full bg-gray-900/80 p-0'>
      <div className='mx-auto flex h-full w-full items-center justify-center'>
        <div role='status' className='absolute left-1/2 top-2/4 -translate-x-1/2 -translate-y-1/2'>
          <svg
            aria-hidden='true'
            className='mr-2 h-10 w-10 animate-spin fill-gray-900/90 text-gray-300 dark:text-gray-600'
            viewBox='0 0 100 101'
...
export function ScreenSizeIndicator({ withScreenSize = false }: { withScreenSize?: boolean }) {
...
export function WorkInProgress() {
  return (
    <div className='mx-9 grid h-full place-content-center'>
      <h1 className='text-center text-3xl font-extrabold'>Coming Soon</h1>
      <h1 className='font-base text-center text-base'>
